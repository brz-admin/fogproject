...
$foglang['Gitea Snapin Management'] = _('Gitea Snapin Management');
$foglang['Check for Updates'] = _('Check for Updates');
$foglang['Automatic Updates'] = _('Automatic Updates');
$foglang['Auto-Refresh Enabled'] = _('Auto-Refresh Enabled');
$foglang['Enable automatic repository refresh'] = _('Enable automatic repository refresh');
$foglang['Refresh Interval'] = _('Refresh Interval');
$foglang['How often to automatically check for repository updates'] = _('How often to automatically check for repository updates');
$foglang['Last Check'] = _('Last Check');
$foglang['Save Settings'] = _('Save Settings');
$foglang['Updates Available'] = _('Updates Available');
$foglang['Metadata Updates'] = _('Metadata Updates');
$foglang['New Repositories'] = _('New Repositories');
$foglang['Apply All Updates'] = _('Apply All Updates');
$foglang['Checking for updates...'] = _('Checking for updates...');
$foglang['All snapins are up to date!'] = _('All snapins are up to date!');
$foglang['Applying...'] = _('Applying...');
$foglang['Some updates failed'] = _('Some updates failed');
